   ...
   public function getDetails(): \Illuminate\Http\JsonResponse
{
    ...
    $academic = StudentAcademic::where('student_id', $student->id)
        ->with(['studyMode', 'department']) // Eager load study mode and department
        ->first();
    ...
    public function submitDetails(Request $request): \Illuminate\Http\JsonResponse
    {
        ...
        if ($request->has('fname') || $request->has('firstName')) {
            $validated = $request->validate([
                ...
                'state_of_origin' => 'sometimes|string|max:255', // Alternative field name
        ...
        if ($studentNysc) {
            $profile['nysc_details'] = [
                'personal_info' => [
                    ...
                    'state_of_origin' => $studentNysc->state_of_origin,
                    'lga' => $studentNysc->lga,
                ...
                'academic_info' => [
                    ...
                    'course_of_study' => $studentNysc->course_of_study,
